  ...
  return (
    <KeyboardAvoidingView
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <PretendardText fontsize={32} fontWeight={'Bold'} style={styles.title}>아티스트별 악곡 검색</PretendardText>
        <SearchBar placeholder="아티스트명을 입력하세요." searchKeyword={searchKeyword} onSearch={setSearchKeyword} onSearchButtonPress={() => {handleSearch(searchKeyword)}} />
        {
